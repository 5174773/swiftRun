...
class MainViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.titleLabel.font = UIFont.boldSystemFont(ofSize: (Display.getSize(size: 52)))
        self.view.addSubview(self.titleLabel)
        self.titleLabel.snp.makeConstraints { (mask) in
            mask.left.equalTo(Display.getSize(size: 94))
            mask.top.equalTo(Display.getSize(size: 230))
        }
        
        // woman 按钮
        self.womanButton.setTitle("Woman", for: .normal)
        self.womanButton.setTitleColor(UIColor(hex: "#c1c1c1"), for: .normal)
        self.womanButton.titleLabel?.font = UIFont.systemFont(ofSize:(Display.getSize(size: 56)))
...
//        self.womanButton.frame = CGRect(x: self.womanButton.frame.origin.x, y: self.womanButton.frame.origin.y, width: 280, height: 49)
        ...
        self.womanButton.snp.makeConstraints { (mask) in
            mask.top.equalTo(self.titleLabel.snp.bottom).offset(Display.getSize(size: 62))
            mask.left.equalTo(Display.getSize(size: 95))
            mask.right.equalTo(Display.getSize(size: -95))
            mask.height.equalTo(Display.getSize(size: 98))
        ...
        self.manButton.titleLabel?.font = UIFont.systemFont(ofSize: Display.getSize(size: 56))
        ...
        self.manButton.snp.makeConstraints { (mask) in
            mask.top.equalTo(self.womanButton.snp.bottom).offset(Display.getSize(size: 36))
            mask.left.equalTo(Display.getSize(size: 95))
            mask.right.equalTo(Display.getSize(size: -95))
            mask.height.equalTo(Display.getSize(size: 98))
        }
        ...
        self.plabel.font = UIFont.boldSystemFont(ofSize: Display.getSize(size: 24))
        self.view.addSubview(self.plabel)
        self.plabel.snp.makeConstraints { (mask) in
            mask.top.equalTo(self.manButton.snp.bottom).offset(Display.getSize(size: 28))
            mask.left.equalTo(Display.getSize(size: 95))
        }
        ...
        self.myLabel.font = UIFont.boldSystemFont(ofSize: Display.getSize(size: 52))
        self.view.addSubview(self.myLabel)
        self.myLabel.snp.makeConstraints { (mask) in
            mask.top.equalTo(self.manButton.snp.bottom).offset(Display.getSize(size: 112))
            mask.left.equalTo(Display.getSize(size: 95))
        }
        ...
        self.line.font = UIFont.boldSystemFont(ofSize: Display.getSize(size: 56))
        self.view.addSubview(self.line)
        self.line.snp.makeConstraints { (mask) in
            mask.top.equalTo(self.myLabel.snp.bottom).offset(Display.getSize(size: 95))
            mask.left.equalTo(Display.getSize(size: 95))
            mask.right.equalTo(Display.getSize(size: -95))
        ...
        self.yourLabel.font = UIFont.boldSystemFont(ofSize: Display.getSize(size: 24))
        self.view.addSubview(self.yourLabel)
        self.yourLabel.snp.makeConstraints { (mask) in
            mask.top.equalTo(self.line.snp.bottom).offset(Display.getSize(size: 24))
            mask.left.equalTo(Display.getSize(size: 95))
...
//        self.startBtton.setTitleColor(UIColor(hex: "#ffffff"), for: .normal)
        self.startBtton.titleLabel?.font = UIFont.boldSystemFont(ofSize: Display.getSize(size: 48))
//        self.startBtton.frame = CGRect(x: self.startBtton.frame.origin.x, y: self.startBtton.frame.origin.y, width: 280, height: 52)
        ...
        self.startBtton.layer.insertSublayer(Display.mixColor(view:self.view,from: "ff6316", to: "ff395e"), at: 0)
        self.view.addSubview(self.startBtton)
        self.startBtton.snp.makeConstraints { (mask) in
//            mask.width.equalTo(280)
            
            mask.bottom.equalTo(Display.getSize(size: -108))
            mask.left.equalTo(Display.getSize(size: 90))
            mask.right.equalTo(Display.getSize(size: -90))
            mask.height.equalTo(Display.getSize(size: 104))
        }
    ...
    @objc func loginConfrim(){
        ...
        self.womanButton.setTitle("Woman", for: .highlighted)
        self.womanButton.setTitleColor(UIColor(hex: "#c1c1c1"), for: .highlighted)
//        self.womanButton.layer.insertSublayer(Display.mixColor(view:self.view,from: "ff395e", to: "ff395e"), at: 0)
